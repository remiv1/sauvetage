# Vérification de la présence d'APIs

## Dilicom

### Sur le site Internet Dilicom
...
### Sur le site Internet Zoho

Présence d'une API.
Documentation téléchargée ici : [Fichiers de documentation](./zoho/)
Création du credential Zoho pour [accès API](https://api-console.zoho.eu/)

### Contact d'entreprise Zoho

### Résultat pour Zoho

## Webador

### Sur le site Internet Webador

Présence d'une API.
[Documentation API Webador](./webador_api.json)

### Contact d'entreprise Webador

### Résultat pour Webador
