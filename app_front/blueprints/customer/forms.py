...
class AddressForm(FlaskForm):
    ...
    address_name = StringField(
        "Nom de l'adresse (ex: Domicile, Travail)", validators=[DataRequired()]
    )
...
class EmailForm(FlaskForm):
    ...
    email_name = StringField(
        "Nom de l'email (ex: Personnel, Professionnel)", validators=[DataRequired()]
    )
...
class PhoneForm(FlaskForm):
    ...
    phone_name = StringField(
        "Nom du téléphone (ex: Personnel, Professionnel)", validators=[DataRequired()]
    )
