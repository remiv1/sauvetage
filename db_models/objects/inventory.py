...
class InventoryMovements(WorkingBase, QueryMixin):
    ...
    movement_timestamp: Mapped[datetime] = mapped_column(DateTime, nullable=False,
                                                         default=lambda: datetime.now(timezone.utc),
                                                         comment="Date et heure du mouvement")
    price_at_movement: Mapped[float] = mapped_column(Float,
    ...
    notes: Mapped[str] = mapped_column(String, comment="Notes supplémentaires sur le mouvement")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "movement_timestamp": self.movement_timestamp.isoformat() \
                                    if self.movement_timestamp else None,
