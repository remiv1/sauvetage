...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "state", sa.String(length=100), nullable=False, comment="État/Région"
        ),
        sa.Column(
            "postal_code", sa.String(length=20), nullable=False, comment="Code postal"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "general_object_type", sa.String(), nullable=False, comment="Type d'objet"
        ),
        sa.Column(
            "ean13", sa.String(), nullable=False, comment="Code EAN13 de l'objet"
        ),
        sa.Column("name", sa.String(), nullable=False, comment="Nom de l'objet"),
        sa.Column(
            "description", sa.String(), nullable=False, comment="Description de l'objet"
        ),
        sa.Column(
            "price",
            sa.Numeric(precision=10, scale=2),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column(
            "order_ref", sa.String(), nullable=False, comment="Numéro de commande"
        ),
        ...
        sa.Column(
            "order_state", sa.String(), nullable=False, comment="État de la commande"
        ),
        sa.ForeignKeyConstraint(
            ["supplier_id"],
            ["app_schema.suppliers.id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "diffuser", sa.String(), nullable=False, comment="Diffuseur du livre"
        ),
        ...
        sa.Column(
            "pages", sa.Integer(), nullable=False, comment="Nombre de pages du livre"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["ean13"],
            ["app_schema.general_objects.ean13"],
        ),
        sa.ForeignKeyConstraint(
            ["gln13"],
            ["app_schema.suppliers.gln13"],
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="app_schema",
    )
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column(
            "general_object_id", sa.Integer(), nullable=False, comment="ID de l'objet"
        ),
        sa.Column(
            "movement_type",
            sa.String(),
        ...
        sa.Column(
            "quantity", sa.Integer(), nullable=False, comment="Quantité du mouvement"
        ),
        sa.Column(
            "movement_timestamp",
            sa.DateTime(),
    ...
    op.create_table(
        ...
        sa.Column(
            "file_name", sa.String(), nullable=False, comment="Nom du fichier média"
        ),
        sa.Column(
            "file_type",
            sa.String(),
    ...
    op.create_table(
        ...
        sa.Column(
            "tag_id", sa.Integer(), nullable=False, comment="Identifiant du tag associé"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["delivery_address_id"],
            ["app_schema.customer_addresses.id"],
        ),
        sa.ForeignKeyConstraint(
            ["invoice_address_id"],
            ["app_schema.customer_addresses.id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "qty_ordered", sa.Integer(), nullable=False, comment="Quantité commandée"
        ),
        sa.Column(
            "qty_received", sa.Integer(), nullable=False, comment="Quantité reçue"
        ),
        sa.Column(
            "unit_price",
            sa.Numeric(precision=10, scale=2, decimal_return_scale=True),
            nullable=False,
            comment="Prix unitaire en centimes d'euro",
        ),
        sa.Column(
            "vat_rate",
            sa.Numeric(precision=10, scale=3, decimal_return_scale=True),
            nullable=False,
        ...
        sa.ForeignKeyConstraint(
            ["inventory_movement_id"],
            ["app_schema.inventory_movements.id"],
        ),
        sa.ForeignKeyConstraint(
            ["order_in_id"],
            ["app_schema.order_in.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="app_schema",
    )
    op.create_table(
        ...
        sa.Column(
            "quantity", sa.Integer(), nullable=False, comment="Quantité commandée"
        ),
        sa.Column(
            "unit_price",
            sa.Numeric(precision=10, scale=2),
        ...
        sa.ForeignKeyConstraint(
            ["invoice_id"],
            ["app_schema.invoices.id"],
        ),
        sa.ForeignKeyConstraint(
            ["order_id"],
            ["app_schema.orders.id"],
        ),
        sa.ForeignKeyConstraint(
            ["shipment_id"],
            ["app_schema.shipments.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="app_schema",
    )
