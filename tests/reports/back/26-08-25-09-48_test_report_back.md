...
**Date:** 2026-08-25T09:48:27.806317+02:00
**Suite:** pytest tests
...
| tests.back.dilicom_import | reproduces_dif499492052_price_year_and_metadata | ✅ PASSED | 0.164 |
| tests.back.dilicom_import | dilicom_real_file_extracts_language_collection_dimensions... | ✅ PASSED | 0.039 |
| tests.back.dilicom_import | dilicom_extracts_bnf_metadata_when_present | ✅ PASSED | 0.019 |
| tests.back.dilicom_import | get_values_from_onix_returns_sqlalchemy_object_price | ✅ PASSED | 0.020 |
| tests.back.dilicom_import | save_or_update_from_object_keeps_taxable_amount_and_vat_r... | ✅ PASSED | 0.461 |
| tests.back.dilicom_import | dilicom_service_uses_cached_vat_rates | ✅ PASSED | 0.011 |
| tests.back.dilicom_import | update_status_handles_already_created_reference | ✅ PASSED | 0.014 |
| tests.back.dilicom_import | save_or_update_from_object_is_idempotent_on_same_ean | ✅ PASSED | 0.154 |
...
| tests.back.mails_api | send_mail_payload_returns_502_on_smtp_error | ✅ PASSED | 0.005 |
...
*Generated on 2026-08-25 09:48:31*
