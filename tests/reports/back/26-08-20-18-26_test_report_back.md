...
**Date:** 2026-08-20T18:26:36.566526+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.back.dilicom_import | price_ht_uses_taxable_amount_when_present | ✅ PASSED | 0.119 |
| tests.back.dilicom_import | reproduces_dif499492052_price_year_and_metadata | ✅ PASSED | 0.152 |
| tests.back.dilicom_import | dilicom_real_file_extracts_language_collection_dimensions... | ✅ PASSED | 0.037 |
| tests.back.dilicom_import | dilicom_extracts_bnf_metadata_when_present | ✅ PASSED | 0.022 |
| tests.back.dilicom_import | get_values_from_onix_returns_sqlalchemy_object_price | ✅ PASSED | 0.024 |
| tests.back.dilicom_import | save_or_update_from_object_keeps_taxable_amount_and_vat_r... | ✅ PASSED | 0.582 |
...
| tests.back.dilicom_import | save_or_update_from_object_is_idempotent_on_same_ean | ✅ PASSED | 0.041 |
| tests.back.documents_api | create_document_logs_exception_and_raises_500 | ✅ PASSED | 0.002 |
| tests.back.mails_api | send_mail_payload_returns_smtp_acceptance | ✅ PASSED | 0.060 |
...
| tests.back.security_migration_decorators | run_startup_tasks_falls_back_when_postgres_lock_fails | ✅ PASSED | 0.006 |
...
*Generated on 2026-08-20 18:26:40*
