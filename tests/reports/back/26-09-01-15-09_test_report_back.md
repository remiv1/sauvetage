...
**Date:** 2026-09-01T15:09:26.144869+02:00
**Suite:** pytest tests
...
| tests.back.dilicom_import | reproduces_dif499492052_price_year_and_metadata | ✅ PASSED | 0.160 |
| tests.back.dilicom_import | dilicom_fixture_extracts_language_dimensions_and_weight_m... | ✅ PASSED | 0.020 |
| tests.back.dilicom_import | dilicom_extracts_bnf_metadata_when_present | ✅ PASSED | 0.018 |
| tests.back.dilicom_import | get_values_from_onix_returns_sqlalchemy_object_price | ✅ PASSED | 0.019 |
| tests.back.dilicom_import | dilicom_imports_two_vat_prices_for_single_product | ✅ PASSED | 1.316 |
| tests.back.dilicom_import | dilicom_metadata_ignores_supporting_resources_but_keeps_b... | ✅ PASSED | 0.018 |
| tests.back.dilicom_import | save_or_update_from_object_keeps_taxable_amount_and_vat_r... | ✅ PASSED | 0.850 |
...
| tests.back.dilicom_import | save_or_update_from_object_is_idempotent_on_same_ean | ✅ PASSED | 1.680 |
...
| tests.back.sync_partners | sync_customer_logs_update_operation_for_known_partners | ✅ PASSED | 0.075 |
...
*Generated on 2026-09-01 15:09:33*
