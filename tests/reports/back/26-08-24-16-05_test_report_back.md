...
**Date:** 2026-08-24T16:05:22.784167+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.back.dilicom_import | price_ht_uses_taxable_amount_when_present | ✅ PASSED | 0.118 |
| tests.back.dilicom_import | reproduces_dif499492052_price_year_and_metadata | ✅ PASSED | 0.161 |
...
| tests.back.dilicom_import | save_or_update_from_object_keeps_taxable_amount_and_vat_r... | ✅ PASSED | 0.438 |
...
| tests.back.dilicom_import | save_or_update_from_object_is_idempotent_on_same_ean | ✅ PASSED | 0.036 |
...
| tests.back.mails_api | build_supplier_order_mail_returns_500_when_pdf_generation... | ✅ PASSED | 0.006 |
...
| tests.back.sync_partners | sync_all_products_exports_woocommerce_then_henrri | ✅ PASSED | 0.004 |
...
| tests.back.vat_sync | vat_slug_duplicates_are_rejected_before_woocommerce_sync | ✅ PASSED | 0.005 |
...
*Generated on 2026-08-24 16:05:26*
