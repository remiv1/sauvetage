...
**Date:** 2026-08-25T19:48:24.993794+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.back.dilicom_import | price_ht_uses_taxable_amount_when_present | ✅ PASSED | 0.120 |
...
| tests.back.dilicom_import | dilicom_imports_two_vat_prices_for_single_product | ✅ PASSED | 0.408 |
| tests.back.dilicom_import | dilicom_metadata_ignores_supporting_resources_but_keeps_b... | ✅ PASSED | 0.018 |
| tests.back.dilicom_import | save_or_update_from_object_keeps_taxable_amount_and_vat_r... | ✅ PASSED | 0.027 |
| tests.back.dilicom_import | dilicom_service_uses_cached_vat_rates | ✅ PASSED | 0.010 |
| tests.back.dilicom_import | update_status_handles_already_created_reference | ✅ PASSED | 0.013 |
| tests.back.dilicom_import | save_or_update_from_object_is_idempotent_on_same_ean | ✅ PASSED | 0.040 |
...
| tests.back.mails_api | build_supplier_order_mail_returns_500_when_pdf_generation... | ✅ PASSED | 0.005 |
...
| tests.back.sync_partners | sync_customer_logs_update_operation_for_known_partners | ✅ PASSED | 0.076 |
...
*Generated on 2026-08-25 19:48:29*
