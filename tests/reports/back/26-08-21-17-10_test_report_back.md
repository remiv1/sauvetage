...
**Date:** 2026-08-21T17:10:30.968541+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.back.dilicom_import | price_ht_uses_taxable_amount_when_present | ✅ PASSED | 0.121 |
| tests.back.dilicom_import | reproduces_dif499492052_price_year_and_metadata | ✅ PASSED | 0.150 |
...
| tests.back.dilicom_import | save_or_update_from_object_keeps_taxable_amount_and_vat_r... | ✅ PASSED | 0.393 |
| tests.back.dilicom_import | dilicom_service_uses_cached_vat_rates | ✅ PASSED | 0.014 |
...
| tests.back.sync_partners | sync_customer_pushes_to_both_partners | ✅ PASSED | 0.004 |
| tests.back.sync_partners | sync_customer_isolates_partner_failures | ✅ PASSED | 0.006 |
...
*Generated on 2026-08-21 17:10:34*
