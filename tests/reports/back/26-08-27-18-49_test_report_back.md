...
**Date:** 2026-08-27T18:49:32.077025+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.back.dilicom_import | price_ht_uses_taxable_amount_when_present | ✅ PASSED | 0.098 |
| tests.back.dilicom_import | dilicom_extracts_price_effective_date | ✅ PASSED | 0.003 |
| tests.back.dilicom_import | reproduces_dif499492052_price_year_and_metadata | ✅ PASSED | 0.155 |
| tests.back.dilicom_import | dilicom_fixture_extracts_language_dimensions_and_weight_m... | ✅ PASSED | 0.018 |
| tests.back.dilicom_import | dilicom_extracts_bnf_metadata_when_present | ✅ PASSED | 0.017 |
| tests.back.dilicom_import | get_values_from_onix_returns_sqlalchemy_object_price | ✅ PASSED | 0.018 |
| tests.back.dilicom_import | dilicom_imports_two_vat_prices_for_single_product | ✅ PASSED | 1.380 |
| tests.back.dilicom_import | dilicom_metadata_ignores_supporting_resources_but_keeps_b... | ✅ PASSED | 0.018 |
| tests.back.dilicom_import | save_or_update_from_object_keeps_taxable_amount_and_vat_r... | ✅ PASSED | 0.957 |
| tests.back.dilicom_import | dilicom_service_uses_cached_vat_rates | ✅ PASSED | 0.009 |
| tests.back.dilicom_import | update_status_handles_already_created_reference | ✅ PASSED | 0.014 |
| tests.back.dilicom_import | save_or_update_from_object_is_idempotent_on_same_ean | ✅ PASSED | 1.943 |
...
| tests.back.mails_api | send_mail_payload_returns_smtp_acceptance | ✅ PASSED | 0.003 |
| tests.back.mails_api | send_mail_payload_rejects_invalid_base64_attachment | ✅ PASSED | 0.001 |
| tests.back.mails_api | send_mail_payload_returns_502_on_smtp_error | ✅ PASSED | 0.003 |
...
| tests.back.security_migration_decorators | ensure_vat_adds_only_missing_rates | ✅ PASSED | 0.005 |
...
| tests.back.sync_partners | sync_customer_logs_update_operation_for_known_partners | ✅ PASSED | 0.079 |
...
*Generated on 2026-08-27 18:49:39*
