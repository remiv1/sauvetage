...
**Date:** 2026-08-25T09:47:57.783365+02:00
**Suite:** pytest tests
...
| tests.db_objects.henrri_payloads | henri_service_configures_http_timeout | ✅ PASSED | 0.098 |
...
| tests.db_objects.henrri_payloads | customer_partners_push_uses_partner_sync_for_both_targets | ✅ PASSED | 0.008 |
...
| tests.db_objects.inventory | multiple_prices_can_have_distinct_vat_rates | ✅ PASSED | 0.028 |
| tests.db_objects.inventory | order_line_is_split_for_multiple_valid_prices | ✅ PASSED | 0.065 |
| tests.db_objects.inventory | multi_price_order_can_be_invoiced_and_shipped_by_split_lines | ✅ PASSED | 0.332 |
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.039 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.073 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 0.388 |
| tests.db_objects.orders | cancel_order_cancels_lines_and_releases_reservations | ✅ PASSED | 0.002 |
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.081 |
| tests.db_objects.users | user_to_dict | ✅ PASSED | 0.033 |
| tests.db_objects.users | user_from_dict | ✅ PASSED | 0.001 |
| tests.db_objects.users | complete_user | ✅ PASSED | 0.020 |
...
| tests.db_objects.woo_payloads | woo_media_route_serves_existing_absolute_local_file | ✅ PASSED | 0.075 |
...
| tests.db_objects.woo_payloads.media | wc_product_build_media_src_uses_internal_public_host_when... | ✅ PASSED | 0.006 |
...
| tests.db_objects.woo_payloads.products | general_object_payload_uses_wc_tax_slug | ✅ PASSED | 0.002 |
...
*Generated on 2026-08-25 09:48:01*
