...
**Date:** 2026-08-20T18:26:05.330822+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.db_objects.customers | customer_create_read_and_update | ✅ PASSED | 0.169 |
| tests.db_objects.customers | create_complete_customer | ✅ PASSED | 0.041 |
...
| tests.db_objects.henrri_payloads | henri_service_configures_http_timeout | ✅ PASSED | 0.212 |
...
| tests.db_objects.henrri_payloads | customer_wc_push_returns_http_error_when_sync_fails | ✅ PASSED | 0.012 |
...
| tests.db_objects.inventory | order_line_is_split_for_multiple_valid_prices | ✅ PASSED | 0.071 |
| tests.db_objects.inventory | multi_price_order_can_be_invoiced_and_shipped_by_split_lines | ✅ PASSED | 0.445 |
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.033 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.065 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 0.043 |
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.077 |
...
| tests.db_objects.woo_payloads.orders | wc_orders_service_creates_missing_products_before_push | ✅ PASSED | 0.010 |
...
*Generated on 2026-08-20 18:26:08*
