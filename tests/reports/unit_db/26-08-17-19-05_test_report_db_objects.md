...
**Date:** 2026-08-17T19:05:38.414075
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.db_objects.customers | customer_create_read_and_update | ✅ PASSED | 0.149 |
| tests.db_objects.customers | create_complete_customer | ✅ PASSED | 0.023 |
...
| tests.db_objects.henrri_payloads | henri_service_configures_http_timeout | ✅ PASSED | 0.049 |
| tests.db_objects.henrri_payloads | henri_invoice_orchestrates_customer_product_and_document | ✅ PASSED | 0.003 |
...
| tests.db_objects.henrri_payloads | customer_wc_push_returns_http_error_when_sync_fails | ✅ PASSED | 0.004 |
| tests.db_objects.henrri_payloads | order_wc_push_returns_http_error_when_sync_fails | ✅ PASSED | 0.002 |
...
| tests.db_objects.henrri_payloads | create_invoice_reuses_existing_remote_customer_and_product | ✅ PASSED | 0.003 |
| tests.db_objects.inventory | multiple_prices_can_have_distinct_vat_rates | ✅ PASSED | 0.014 |
| tests.db_objects.inventory | order_line_is_split_for_multiple_valid_prices | ✅ PASSED | 0.036 |
| tests.db_objects.inventory | multi_price_order_can_be_invoiced_and_shipped_by_split_lines | ✅ PASSED | 0.339 |
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.019 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.040 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 0.021 |
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.042 |
| tests.db_objects.users | user_to_dict | ✅ PASSED | 0.021 |
| tests.db_objects.users | user_from_dict | ✅ PASSED | 0.000 |
| tests.db_objects.users | complete_user | ✅ PASSED | 0.010 |
...
| tests.db_objects.woo_payloads | object_tag_payload_uses_wc_tag_id | ✅ PASSED | 0.000 |
| tests.db_objects.woo_payloads | wc_product_payload_includes_synced_tags | ✅ PASSED | 0.001 |
| tests.db_objects.woo_payloads | update_product_syncs_missing_wc_tags_before_export | ✅ PASSED | 0.005 |
...
| tests.db_objects.woo_payloads | woo_media_route_resolves_media_by_id_and_serves_file | ✅ PASSED | 0.002 |
...
| tests.db_objects.woo_payloads | woo_media_route_serves_existing_absolute_local_file | ✅ PASSED | 0.006 |
| tests.db_objects.woo_payloads | woo_media_route_detects_real_mime_from_file_content | ✅ PASSED | 0.003 |
| tests.db_objects.woo_payloads | wc_orders_service_creates_missing_products_before_push | ✅ PASSED | 0.005 |
| tests.db_objects.woo_payloads | wc_orders_service_push_order_updates_remote_order_and_log... | ✅ PASSED | 0.004 |
...
| tests.db_objects.woo_payloads.media | woo_media_route_resolves_media_by_id_and_serves_file | ✅ PASSED | 0.002 |
...
| tests.db_objects.woo_payloads.media | woo_media_route_detects_real_mime_from_file_content | ✅ PASSED | 0.003 |
...
| tests.db_objects.woo_payloads.orders | wc_orders_service_creates_missing_products_before_push | ✅ PASSED | 0.063 |
| tests.db_objects.woo_payloads.orders | wc_orders_service_push_order_updates_remote_order_and_log... | ✅ PASSED | 0.004 |
...
| tests.db_objects.woo_payloads.products | update_product_syncs_missing_wc_tags_before_export | ✅ PASSED | 0.004 |
...
*Generated on 2026-08-17 19:05:38*
