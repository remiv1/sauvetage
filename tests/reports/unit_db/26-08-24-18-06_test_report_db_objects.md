...
**Date:** 2026-08-24T18:06:28.278946+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.db_objects.customers | customer_create_read_and_update | ✅ PASSED | 0.234 |
| tests.db_objects.customers | create_complete_customer | ✅ PASSED | 0.044 |
...
| tests.db_objects.henrri_payloads | henri_service_configures_http_timeout | ✅ PASSED | 0.081 |
...
| tests.db_objects.henrri_payloads | check_customer_returns_false_when_customer_lookup_fails | ✅ PASSED | 0.003 |
| tests.db_objects.henrri_payloads | create_invoice_updates_known_customer_product_and_document | ✅ PASSED | 0.006 |
...
| tests.db_objects.inventory | multiple_prices_can_have_distinct_vat_rates | ✅ PASSED | 0.026 |
| tests.db_objects.inventory | order_line_is_split_for_multiple_valid_prices | ✅ PASSED | 0.065 |
| tests.db_objects.inventory | multi_price_order_can_be_invoiced_and_shipped_by_split_lines | ✅ PASSED | 0.324 |
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.033 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.069 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 0.121 |
| tests.db_objects.orders | cancel_order_cancels_lines_and_releases_reservations | ✅ PASSED | 0.002 |
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.082 |
| tests.db_objects.users | user_to_dict | ✅ PASSED | 0.029 |
...
| tests.db_objects.woo_payloads | wc_product_update_fails_when_woo_returns_no_wc_id | ✅ PASSED | 0.005 |
...
| tests.db_objects.woo_payloads | woo_media_route_uses_basename_for_local_file | ✅ PASSED | 0.003 |
| tests.db_objects.woo_payloads | woo_media_route_serves_existing_absolute_local_file | ✅ PASSED | 0.008 |
| tests.db_objects.woo_payloads | woo_media_route_detects_real_mime_from_file_content | ✅ PASSED | 0.063 |
...
| tests.db_objects.woo_payloads.media | wc_product_build_media_src_uses_token_for_absolute_local_... | ✅ PASSED | 0.004 |
...
| tests.db_objects.woo_payloads.orders | wc_orders_service_creates_missing_products_before_push | ✅ PASSED | 0.008 |
...
| tests.db_objects.woo_payloads.products | wc_product_variations_are_reconciled | ✅ PASSED | 0.006 |
...
*Generated on 2026-08-24 18:06:31*
