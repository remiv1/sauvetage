...
**Date:** 2026-08-28T19:17:08.473094+02:00
**Suite:** pytest tests
...
| tests.db_objects.henrri_payloads | henri_shipping_fee_line_is_sent_with_inline_item | ✅ PASSED | 0.001 |
| tests.db_objects.henrri_payloads | henri_shipping_fee_does_not_synchronize_a_product | ✅ PASSED | 0.001 |
| tests.db_objects.henrri_payloads | henri_service_configures_http_timeout | ✅ PASSED | 0.104 |
...
| tests.db_objects.henrri_upsert | sync_customer_sends_full_address | ✅ PASSED | 0.003 |
| tests.db_objects.henrri_upsert | sync_customer_updates_contact_separately | ✅ PASSED | 0.002 |
| tests.db_objects.henrri_upsert | sync_customer_passes_known_identifier_for_update | ✅ PASSED | 0.002 |
...
| tests.db_objects.inventory | order_line_is_split_for_multiple_valid_prices | ✅ PASSED | 0.065 |
| tests.db_objects.inventory | multi_price_order_can_be_invoiced_and_shipped_by_split_lines | ✅ PASSED | 0.305 |
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.036 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.076 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 0.376 |
...
| tests.db_objects.order_shipping_fee | ship_order_rejects_shipping_fee_line | ✅ PASSED | 0.003 |
...
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.086 |
| tests.db_objects.users | user_to_dict | ✅ PASSED | 0.032 |
| tests.db_objects.users | user_from_dict | ✅ PASSED | 0.001 |
| tests.db_objects.users | complete_user | ✅ PASSED | 0.017 |
| tests.db_objects.woo_payloads | wc_customer_sync_links_existing_customer_by_email | ✅ PASSED | 0.003 |
| tests.db_objects.woo_payloads | wc_customer_sync_creates_and_links_missing_customer | ✅ PASSED | 0.004 |
| tests.db_objects.woo_payloads | customer_repository_updates_partner_identifiers | ✅ PASSED | 0.001 |
...
| tests.db_objects.woo_payloads | imported_shipping_fee_is_converted_to_fee_line | ✅ PASSED | 0.002 |
...
| tests.db_objects.woo_payloads | wc_product_update_fails_when_woo_returns_no_wc_id | ✅ PASSED | 0.068 |
| tests.db_objects.woo_payloads | wc_product_build_media_src_uses_internal_public_host_when... | ✅ PASSED | 0.006 |
...
| tests.db_objects.woo_payloads.products | wc_product_builds_catalog_payload_with_merged_attributes | ✅ PASSED | 0.003 |
...
*Generated on 2026-08-28 19:17:11*
