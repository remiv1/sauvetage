...
**Date:** 2026-08-24T08:49:05.820258+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.db_objects.customers | customer_create_read_and_update | ✅ PASSED | 0.256 |
| tests.db_objects.customers | create_complete_customer | ✅ PASSED | 0.045 |
...
| tests.db_objects.henrri_addresses | customer_without_active_billing_address_raises | ✅ PASSED | 0.003 |
| tests.db_objects.henrri_payloads | customer_to_dict_henrri_contract_for_professional | ✅ PASSED | 0.002 |
| tests.db_objects.henrri_payloads | customer_to_dict_henrri_normalizes_empty_professional_vat... | ✅ PASSED | 0.002 |
| tests.db_objects.henrri_payloads | customer_to_dict_henrri_contract_for_individual | ✅ PASSED | 0.002 |
...
| tests.db_objects.henrri_payloads | henri_product_contract | ✅ PASSED | 0.002 |
| tests.db_objects.henrri_payloads | henri_invoice_line_contract_omits_totals_when_tax_is_excl... | ✅ PASSED | 0.002 |
| tests.db_objects.henrri_payloads | henri_service_configures_http_timeout | ✅ PASSED | 0.088 |
| tests.db_objects.henrri_payloads | henri_invoice_orchestrates_customer_product_and_document | ✅ PASSED | 0.007 |
...
| tests.db_objects.henrri_payloads | sync_invoice_with_henrri_logs_failed_status_when_sync_fails | ✅ PASSED | 0.004 |
| tests.db_objects.henrri_payloads | customer_partners_push_uses_partner_sync_for_both_targets | ✅ PASSED | 0.007 |
| tests.db_objects.henrri_payloads | customer_partners_push_returns_http_error_when_sync_fails | ✅ PASSED | 0.004 |
| tests.db_objects.henrri_payloads | order_wc_push_returns_http_error_when_sync_fails | ✅ PASSED | 0.004 |
| tests.db_objects.henrri_payloads | invoice_order_rejects_already_fully_invoiced_order | ✅ PASSED | 0.004 |
...
| tests.db_objects.henrri_payloads | create_invoice_updates_known_customer_product_and_document | ✅ PASSED | 0.008 |
| tests.db_objects.henrri_payloads | create_invoice_leaves_finalized_remote_document_untouched | ✅ PASSED | 0.007 |
| tests.db_objects.henrri_upsert | upsert_customer_creates_when_identifier_is_unknown | ✅ PASSED | 0.003 |
| tests.db_objects.henrri_upsert | upsert_customer_updates_when_identifier_is_known | ✅ PASSED | 0.002 |
...
| tests.db_objects.inventory | order_line_is_split_for_multiple_valid_prices | ✅ PASSED | 0.075 |
| tests.db_objects.inventory | multi_price_order_can_be_invoiced_and_shipped_by_split_lines | ✅ PASSED | 0.352 |
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.037 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.074 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 0.045 |
| tests.db_objects.orders | cancel_order_cancels_lines_and_releases_reservations | ✅ PASSED | 0.003 |
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.094 |
| tests.db_objects.users | user_to_dict | ✅ PASSED | 0.034 |
| tests.db_objects.users | user_from_dict | ✅ PASSED | 0.001 |
| tests.db_objects.users | complete_user | ✅ PASSED | 0.021 |
...
| tests.db_objects.woo_payloads | update_product_syncs_missing_wc_tags_before_export | ✅ PASSED | 0.009 |
...
| tests.db_objects.woo_payloads | returned_order_payload_uses_refunded_status | ✅ PASSED | 0.001 |
...
| tests.db_objects.woo_payloads | woo_media_route_serves_existing_absolute_local_file | ✅ PASSED | 0.008 |
| tests.db_objects.woo_payloads | woo_media_route_detects_real_mime_from_file_content | ✅ PASSED | 0.005 |
| tests.db_objects.woo_payloads | wc_orders_service_creates_missing_products_before_push | ✅ PASSED | 0.008 |
| tests.db_objects.woo_payloads | wc_orders_service_push_order_updates_remote_order_and_log... | ✅ PASSED | 0.009 |
| tests.db_objects.woo_payloads | customer_payload_and_repo_match_woo_customer_id | ✅ PASSED | 0.004 |
...
| tests.db_objects.woo_payloads.media | woo_media_route_serves_existing_absolute_local_file | ✅ PASSED | 0.006 |
| tests.db_objects.woo_payloads.media | woo_media_route_detects_real_mime_from_file_content | ✅ PASSED | 0.007 |
...
| tests.db_objects.woo_payloads.orders | wc_orders_service_uses_customer_woo_email_and_remote_cust... | ✅ PASSED | 0.075 |
...
| tests.db_objects.woo_payloads.orders | wc_orders_service_push_order_updates_remote_order_and_log... | ✅ PASSED | 0.007 |
...
| tests.db_objects.woo_payloads.products | wc_product_update_fails_when_woo_returns_no_wc_id | ✅ PASSED | 0.006 |
| tests.db_objects.woo_payloads.products | match_line_to_wc_uses_product_and_variation_ids | ✅ PASSED | 0.001 |

---

*Generated on 2026-08-24 08:49:09*
