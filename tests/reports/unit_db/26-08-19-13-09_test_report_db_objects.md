...
**Date:** 2026-08-19T13:09:20.156839
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.db_objects.customers | customer_create_read_and_update | ✅ PASSED | 0.163 |
| tests.db_objects.customers | create_complete_customer | ✅ PASSED | 0.025 |
...
| tests.db_objects.henrri_payloads | henri_invoice_orchestrates_customer_product_and_document | ✅ PASSED | 0.004 |
...
| tests.db_objects.inventory | multiple_prices_can_have_distinct_vat_rates | ✅ PASSED | 0.015 |
| tests.db_objects.inventory | order_line_is_split_for_multiple_valid_prices | ✅ PASSED | 0.038 |
| tests.db_objects.inventory | multi_price_order_can_be_invoiced_and_shipped_by_split_lines | ✅ PASSED | 0.348 |
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.019 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.040 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 1.145 |
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.043 |
...
| tests.db_objects.woo_payloads | wc_orders_service_push_order_updates_remote_order_and_log... | ✅ PASSED | 0.005 |
...
| tests.db_objects.woo_payloads.media | woo_media_route_serves_existing_absolute_local_file | ✅ PASSED | 0.004 |
...
| tests.db_objects.woo_payloads.products | update_product_syncs_missing_wc_tags_before_export | ✅ PASSED | 0.005 |
...
*Generated on 2026-08-19 13:09:20*
