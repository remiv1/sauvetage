...
**Date:** 2026-08-22T15:13:09.080583+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.db_objects.customers | customer_create_read_and_update | ✅ PASSED | 0.197 |
| tests.db_objects.customers | create_complete_customer | ✅ PASSED | 0.057 |
...
| tests.db_objects.henrri_payloads | henri_service_configures_http_timeout | ✅ PASSED | 0.105 |
...
| tests.db_objects.henrri_payloads | order_wc_push_returns_http_error_when_sync_fails | ✅ PASSED | 0.005 |
...
| tests.db_objects.henrri_upsert | sync_customer_passes_known_identifier_for_update | ✅ PASSED | 0.004 |
| tests.db_objects.henrri_upsert | sync_product_persists_returned_identifier | ✅ PASSED | 0.002 |
| tests.db_objects.inventory | multiple_prices_can_have_distinct_vat_rates | ✅ PASSED | 0.050 |
| tests.db_objects.inventory | order_line_is_split_for_multiple_valid_prices | ✅ PASSED | 0.086 |
| tests.db_objects.inventory | multi_price_order_can_be_invoiced_and_shipped_by_split_lines | ✅ PASSED | 0.372 |
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.048 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.137 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 0.047 |
| tests.db_objects.orders | cancel_order_cancels_lines_and_releases_reservations | ✅ PASSED | 0.002 |
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.076 |
| tests.db_objects.users | user_to_dict | ✅ PASSED | 0.043 |
| tests.db_objects.users | user_from_dict | ✅ PASSED | 0.001 |
| tests.db_objects.users | complete_user | ✅ PASSED | 0.025 |
...
| tests.db_objects.woo_payloads.media | wc_product_build_media_src_uses_token_for_absolute_local_... | ✅ PASSED | 0.005 |
...
*Generated on 2026-08-22 15:13:12*
