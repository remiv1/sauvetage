...
**Date:** 2026-08-25T19:47:54.912976+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.db_objects.customers | customer_create_read_and_update | ✅ PASSED | 0.233 |
...
| tests.db_objects.inventory | multiple_prices_can_have_distinct_vat_rates | ✅ PASSED | 0.032 |
...
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 0.271 |
...
| tests.db_objects.users | user_to_dict | ✅ PASSED | 0.040 |
| tests.db_objects.users | user_from_dict | ✅ PASSED | 0.001 |
| tests.db_objects.users | complete_user | ✅ PASSED | 0.022 |
...
| tests.db_objects.woo_payloads | woo_media_route_serves_existing_absolute_local_file | ✅ PASSED | 0.065 |
...
| tests.db_objects.woo_payloads.orders | wc_orders_service_creates_missing_products_before_push | ✅ PASSED | 0.006 |
...
*Generated on 2026-08-25 19:47:58*
