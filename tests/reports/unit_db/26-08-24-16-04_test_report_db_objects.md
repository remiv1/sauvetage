...
**Date:** 2026-08-24T16:04:50.551358+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.db_objects.customers | customer_create_read_and_update | ✅ PASSED | 0.232 |
| tests.db_objects.customers | create_complete_customer | ✅ PASSED | 0.043 |
...
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.035 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.069 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 0.046 |
| tests.db_objects.orders | cancel_order_cancels_lines_and_releases_reservations | ✅ PASSED | 0.002 |
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.080 |
| tests.db_objects.users | user_to_dict | ✅ PASSED | 0.035 |
| tests.db_objects.users | user_from_dict | ✅ PASSED | 0.001 |
| tests.db_objects.users | complete_user | ✅ PASSED | 0.021 |
| tests.db_objects.woo_payloads | wc_customer_sync_links_existing_customer_by_email | ✅ PASSED | 0.004 |
...
| tests.db_objects.woo_payloads | wc_orders_service_creates_missing_remote_customer_when_lo... | ✅ PASSED | 0.006 |
...
| tests.db_objects.woo_payloads | woo_media_route_detects_real_mime_from_file_content | ✅ PASSED | 0.007 |
...
| tests.db_objects.woo_payloads.media | woo_media_route_resolves_media_by_id_and_serves_file | ✅ PASSED | 0.005 |
| tests.db_objects.woo_payloads.media | woo_media_route_uses_basename_for_local_file | ✅ PASSED | 0.074 |
...
*Generated on 2026-08-24 16:04:54*
