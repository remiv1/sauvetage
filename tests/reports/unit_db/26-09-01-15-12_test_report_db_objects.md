...
**Date:** 2026-09-01T15:12:34.091036+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.db_objects.customers | customer_create_read_and_update | ✅ PASSED | 0.210 |
| tests.db_objects.customers | create_complete_customer | ✅ PASSED | 0.055 |
...
| tests.db_objects.henrri_payloads | customer_to_dict_henrri_includes_id_for_update | ✅ PASSED | 0.002 |
| tests.db_objects.henrri_payloads | customer_to_dict_henrri_omits_contact_when_requested | ✅ PASSED | 0.002 |
...
| tests.db_objects.henrri_payloads | henri_shipping_fee_line_uses_synchronized_product_id | ✅ PASSED | 0.001 |
| tests.db_objects.henrri_payloads | henri_shipping_fee_synchronizes_product_on_first_use | ✅ PASSED | 0.002 |
| tests.db_objects.henrri_payloads | henri_service_configures_http_timeout | ✅ PASSED | 0.082 |
| tests.db_objects.henrri_payloads | henri_invoice_orchestrates_customer_product_and_document | ✅ PASSED | 0.006 |
| tests.db_objects.henrri_payloads | create_invoice_does_not_send_lines_when_creating_henrri_d... | ✅ PASSED | 0.006 |
...
| tests.db_objects.henrri_payloads | check_product_returns_true_when_item_exists_in_henrri | ✅ PASSED | 0.003 |
...
| tests.db_objects.henrri_upsert | upsert_product_creates_then_updates | ✅ PASSED | 0.002 |
...
| tests.db_objects.inventory | multiple_prices_can_have_distinct_vat_rates | ✅ PASSED | 0.027 |
| tests.db_objects.inventory | order_line_is_split_for_multiple_valid_prices | ✅ PASSED | 0.070 |
| tests.db_objects.inventory | multi_price_order_can_be_invoiced_and_shipped_by_split_lines | ✅ PASSED | 0.331 |
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.102 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.074 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 0.141 |
| tests.db_objects.order_shipping_fee | shipping_fee_is_allocated_by_discounted_amount_before_tax | ✅ PASSED | 0.001 |
| tests.db_objects.order_shipping_fee | shipping_fee_rounding_remainder_is_kept | ✅ PASSED | 0.001 |
| tests.db_objects.order_shipping_fee | shipping_fee_is_optional | ✅ PASSED | 0.001 |
| tests.db_objects.order_shipping_fee | shipping_fee_uses_negative_quantity_for_credit_note | ✅ PASSED | 0.001 |
| tests.db_objects.order_shipping_fee | invoice_order_flushes_shipping_order_lines_before_invoice... | ✅ PASSED | 0.007 |
| tests.db_objects.order_shipping_fee | ship_order_rejects_shipping_fee_line | ✅ PASSED | 0.002 |
| tests.db_objects.order_shipping_fee | shipping_fee_does_not_make_order_partially_shipped | ✅ PASSED | 0.002 |
| tests.db_objects.orders | cancel_order_cancels_lines_and_releases_reservations | ✅ PASSED | 0.003 |
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.092 |
| tests.db_objects.users | user_to_dict | ✅ PASSED | 0.033 |
| tests.db_objects.users | user_from_dict | ✅ PASSED | 0.001 |
| tests.db_objects.users | complete_user | ✅ PASSED | 0.019 |
...
| tests.db_objects.woo_payloads | update_product_syncs_missing_wc_tags_before_export | ✅ PASSED | 0.008 |
| tests.db_objects.woo_payloads | order_line_payload_uses_wc_tax_class_and_variation_id | ✅ PASSED | 0.002 |
...
| tests.db_objects.woo_payloads | cancelled_order_payload_removes_known_lines | ✅ PASSED | 0.002 |
| tests.db_objects.woo_payloads | order_payload_exports_shipping_fee_in_fee_lines | ✅ PASSED | 0.002 |
| tests.db_objects.woo_payloads | wc_orders_service_stores_fee_line_identifier | ✅ PASSED | 0.001 |
| tests.db_objects.woo_payloads | imported_shipping_fee_is_converted_to_fee_line | ✅ PASSED | 0.003 |
| tests.db_objects.woo_payloads | wc_orders_service_replaces_shipping_identifier_with_fee_i... | ✅ PASSED | 0.001 |
...
| tests.db_objects.woo_payloads | wc_orders_service_uses_customer_woo_email_and_remote_cust... | ✅ PASSED | 0.005 |
| tests.db_objects.woo_payloads | wc_orders_service_creates_missing_remote_customer_when_lo... | ✅ PASSED | 0.005 |
| tests.db_objects.woo_payloads | wc_orders_service_preserves_existing_line_ids | ✅ PASSED | 0.001 |
| tests.db_objects.woo_payloads | wc_product_update_fails_when_woo_returns_no_wc_id | ✅ PASSED | 0.007 |
...
| tests.db_objects.woo_payloads | wc_product_build_media_src_uses_token_for_absolute_local_... | ✅ PASSED | 0.004 |
| tests.db_objects.woo_payloads | woo_media_route_uses_basename_for_local_file | ✅ PASSED | 0.004 |
| tests.db_objects.woo_payloads | woo_media_route_serves_existing_absolute_local_file | ✅ PASSED | 0.009 |
| tests.db_objects.woo_payloads | woo_media_route_detects_real_mime_from_file_content | ✅ PASSED | 0.006 |
| tests.db_objects.woo_payloads | wc_orders_service_creates_missing_products_before_push | ✅ PASSED | 0.009 |
...
| tests.db_objects.woo_payloads.customers | customer_payload_and_repo_match_woo_customer_id | ✅ PASSED | 0.004 |
| tests.db_objects.woo_payloads.customers | professional_customer_payload_uses_string_names | ✅ PASSED | 0.002 |
...
| tests.db_objects.woo_payloads.media | woo_media_route_resolves_media_by_id_and_serves_file | ✅ PASSED | 0.004 |
| tests.db_objects.woo_payloads.media | woo_media_route_uses_basename_for_local_file | ✅ PASSED | 0.004 |
| tests.db_objects.woo_payloads.media | woo_media_route_serves_existing_absolute_local_file | ✅ PASSED | 0.007 |
| tests.db_objects.woo_payloads.media | woo_media_route_detects_real_mime_from_file_content | ✅ PASSED | 0.006 |
| tests.db_objects.woo_payloads.orders | order_line_payload_uses_wc_tax_class_and_variation_id | ✅ PASSED | 0.002 |
| tests.db_objects.woo_payloads.orders | order_line_payload_raises_clear_error_when_product_not_sy... | ✅ PASSED | 0.002 |
| tests.db_objects.woo_payloads.orders | order_payload_uses_wc_customer_and_line_contract | ✅ PASSED | 0.002 |
| tests.db_objects.woo_payloads.orders | wc_orders_service_uses_customer_woo_email_and_remote_cust... | ✅ PASSED | 0.005 |
| tests.db_objects.woo_payloads.orders | wc_orders_service_creates_missing_remote_customer_when_lo... | ✅ PASSED | 0.004 |
...
| tests.db_objects.woo_payloads.orders | wc_orders_service_push_order_updates_remote_order_and_log... | ✅ PASSED | 0.008 |
...
| tests.db_objects.woo_payloads.products | update_product_syncs_missing_wc_tags_before_export | ✅ PASSED | 0.007 |
...
| tests.db_objects.woo_payloads.products | wc_parent_payload_declares_variation_attribute | ✅ PASSED | 0.002 |
...
| tests.db_objects.woo_payloads.products | wc_product_update_fails_when_woo_returns_no_wc_id | ✅ PASSED | 0.007 |
| tests.db_objects.woo_payloads.products | match_line_to_wc_uses_product_and_variation_ids | ✅ PASSED | 0.001 |

---

*Generated on 2026-09-01 15:12:37*
