...
**Date:** 2026-08-24T12:53:21.036286+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.db_objects.customers | customer_create_read_and_update | ✅ PASSED | 0.227 |
| tests.db_objects.customers | create_complete_customer | ✅ PASSED | 0.042 |
...
| tests.db_objects.henrri_payloads | henri_service_configures_http_timeout | ✅ PASSED | 0.176 |
| tests.db_objects.henrri_payloads | henri_invoice_orchestrates_customer_product_and_document | ✅ PASSED | 0.008 |
...
| tests.db_objects.henrri_payloads | customer_partners_push_uses_partner_sync_for_both_targets | ✅ PASSED | 0.012 |
...
| tests.db_objects.henrri_upsert | upsert_customer_creates_when_identifier_is_unknown | ✅ PASSED | 0.001 |
...
| tests.db_objects.inventory | multiple_prices_can_have_distinct_vat_rates | ✅ PASSED | 0.025 |
...
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.034 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.068 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 0.041 |
| tests.db_objects.orders | cancel_order_cancels_lines_and_releases_reservations | ❌ FAILED | 0.002 |
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.040 |
| tests.db_objects.users | user_to_dict | ✅ PASSED | 0.031 |
...
| tests.db_objects.woo_payloads | order_payload_uses_wc_customer_and_line_contract | ❌ FAILED | 0.002 |
| tests.db_objects.woo_payloads | cancelled_order_payload_updates_status_without_zeroing_lines | ❌ FAILED | 0.002 |
...
| tests.db_objects.woo_payloads | woo_media_route_serves_existing_absolute_local_file | ✅ PASSED | 0.007 |
| tests.db_objects.woo_payloads | woo_media_route_detects_real_mime_from_file_content | ✅ PASSED | 0.005 |
| tests.db_objects.woo_payloads | wc_orders_service_creates_missing_products_before_push | ❌ FAILED | 0.005 |
| tests.db_objects.woo_payloads | wc_orders_service_push_order_updates_remote_order_and_log... | ❌ FAILED | 0.005 |
| tests.db_objects.woo_payloads | customer_payload_and_repo_match_woo_customer_id | ✅ PASSED | 0.003 |
| tests.db_objects.woo_payloads.customers | customer_payload_and_repo_match_woo_customer_id | ✅ PASSED | 0.005 |
| tests.db_objects.woo_payloads.customers | professional_customer_payload_uses_string_names | ✅ PASSED | 0.063 |
| tests.db_objects.woo_payloads.media | wc_product_build_media_src_uses_internal_public_host_when... | ✅ PASSED | 0.004 |
...
| tests.db_objects.woo_payloads.orders | order_line_payload_uses_wc_tax_class_and_variation_id | ❌ FAILED | 0.001 |
| tests.db_objects.woo_payloads.orders | order_line_payload_raises_clear_error_when_product_not_sy... | ✅ PASSED | 0.001 |
| tests.db_objects.woo_payloads.orders | order_payload_uses_wc_customer_and_line_contract | ❌ FAILED | 0.002 |
...
| tests.db_objects.woo_payloads.orders | wc_orders_service_creates_missing_products_before_push | ❌ FAILED | 0.005 |
| tests.db_objects.woo_payloads.orders | wc_orders_service_push_order_updates_remote_order_and_log... | ❌ FAILED | 0.005 |
...
| tests.db_objects.woo_payloads.products | wc_product_payload_includes_synced_tags | ✅ PASSED | 0.003 |
...
*Generated on 2026-08-24 12:53:25*
