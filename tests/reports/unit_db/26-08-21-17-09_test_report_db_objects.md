...
**Date:** 2026-08-21T17:10:00.878654+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.db_objects.customers | customer_create_read_and_update | ✅ PASSED | 0.247 |
| tests.db_objects.customers | create_complete_customer | ✅ PASSED | 0.061 |
...
| tests.db_objects.inventory | multiple_prices_can_have_distinct_vat_rates | ✅ PASSED | 0.047 |
| tests.db_objects.inventory | order_line_is_split_for_multiple_valid_prices | ✅ PASSED | 0.082 |
| tests.db_objects.inventory | multi_price_order_can_be_invoiced_and_shipped_by_split_lines | ✅ PASSED | 0.300 |
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.038 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.078 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 1.067 |
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.078 |
| tests.db_objects.users | user_to_dict | ✅ PASSED | 0.043 |
...
| tests.db_objects.woo_payloads | wc_product_build_media_src_uses_internal_public_host_when... | ✅ PASSED | 0.007 |
...
| tests.db_objects.woo_payloads | wc_orders_service_push_order_updates_remote_order_and_log... | ✅ PASSED | 0.065 |
...
*Generated on 2026-08-21 17:10:04*
