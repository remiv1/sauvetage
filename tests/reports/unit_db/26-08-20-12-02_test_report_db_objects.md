...
**Date:** 2026-08-20T12:02:35.487181+02:00
**Suite:** pytest tests
...
| ---------- | --------- | ------ | -------- |
| tests.db_objects.customers | customer_create_read_and_update | ✅ PASSED | 0.219 |
...
| tests.db_objects.henrri_payloads | create_invoice_does_not_send_lines_when_creating_henrri_d... | ✅ PASSED | 0.007 |
...
| tests.db_objects.henrri_payloads | customer_wc_push_returns_http_error_when_sync_fails | ✅ PASSED | 0.006 |
...
| tests.db_objects.inventory | order_line_is_split_for_multiple_valid_prices | ✅ PASSED | 0.063 |
| tests.db_objects.inventory | multi_price_order_can_be_invoiced_and_shipped_by_split_lines | ✅ PASSED | 0.451 |
| tests.db_objects.inventory | add_movements | ✅ PASSED | 0.033 |
| tests.db_objects.objects | object_create_read_and_update | ✅ PASSED | 0.069 |
| tests.db_objects.objects | get_by_ref_finds_existing_object_even_when_inactive | ✅ PASSED | 0.042 |
| tests.db_objects.orders | create_order_with_invoice_and_shipment | ✅ PASSED | 0.075 |
...
| tests.db_objects.woo_payloads | wc_orders_service_push_order_updates_remote_order_and_log... | ✅ PASSED | 0.008 |
...
| tests.db_objects.woo_payloads.media | woo_media_route_detects_real_mime_from_file_content | ✅ PASSED | 0.064 |
...
*Generated on 2026-08-20 12:02:38*
