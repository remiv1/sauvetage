...
revision: str = '8b5c7006b603'  # pylint: disable=invalid-name
down_revision: Union[str, Sequence[str], None] = None  # pylint: disable=invalid-name
branch_labels: Union[str, Sequence[str], None] = None  # pylint: disable=invalid-name
depends_on: Union[str, Sequence[str], None] = None  # pylint: disable=invalid-name

DERNIERE_SYNCHRO = 'Dernière synchronisation'

def upgrade() -> None:
    """Upgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('customers',    # pylint: disable=E1101
    sa.Column(
        'id',
        sa.Integer(),
        autoincrement=True,
    ...
    sa.Column(
        'wpwc_id', sa.String(length=50), nullable=True, comment='Identifiant WooCommerce'
    ),
    sa.Column(
        'henrri_id', sa.String(length=100), nullable=True, comment='Identifiant Henrri'
    ),
    sa.Column(
        'customer_type', sa.String(length=20), nullable=False, comment='Type de client : part/pro'
    ),
    sa.Column(
        'is_active', sa.Boolean(), nullable=False, comment='Statut actif/inactif du client'
    ),
    sa.Column(
        'created_at', sa.DateTime(), nullable=False, comment='Date de création du client'
    ),
    sa.Column(
        'updated_at',
        sa.DateTime(), nullable=False, comment='Date de dernière mise à jour du client'
    ),
    sa.Column(
        'last_synced_at', sa.DateTime(), nullable=True, comment=DERNIERE_SYNCHRO
    ),
    ...
    op.create_table('suppliers',    # pylint: disable=E1101
    sa.Column(
        'id',
        sa.Integer(),
        autoincrement=True,
    ...
    sa.Column(
        'name', sa.String(), nullable=False, comment='Nom du fournisseur'
    ),
    sa.Column(
        'gln13', sa.String(), nullable=False, comment='Code GLN du fournisseur'
    ),
    sa.Column(
        'siren_siret', sa.String(), nullable=True, comment='Numéro SIREN ou SIRET du fournisseur'
    ),
    sa.Column(
        'vat_number', sa.String(), nullable=True, comment='Numéro de TVA intracom fournisseur'
    ),
    sa.Column(
        'address', sa.String(), nullable=True, comment='Adresse complète du fournisseur'
    ),
    sa.Column(
        'contact_email', sa.String(), nullable=True, comment='Email de contact du fournisseur'
    ),
    sa.Column(
        'contact_phone', sa.String(), nullable=True, comment='Téléphone de contact du fournisseur'
    ),
    sa.Column(
        'contact_fax', sa.String(), nullable=True, comment='Fax de contact du fournisseur'
    ),
    sa.Column(
        'web_site', sa.String(), nullable=True, comment='Site web du fournisseur'
    ),
    sa.Column(
        'is_active', sa.Boolean(), nullable=False, comment='Indique si le fournisseur est actif'
    ),
    sa.Column(
        'edi_active', sa.Boolean(), nullable=False,
        comment="Indique si le fournisseur est actif pour l'EDI"
    ),
    sa.Column(
        'collect_days', sa.String(), nullable=True,
        comment="Jours de collecte des commandes (ex: '12345' pour LMMJV)"
    ),
    sa.Column(
        'cutoff_time', sa.String(), nullable=True,
        comment='Heure limite de PEC des commandes pour le jour même.'
    ),
    sa.Column(
        'created_at', sa.DateTime(), nullable=False, comment='Date de création du fournisseur'
    ),
    sa.Column(
        'updated_at', sa.DateTime(), nullable=False, comment='Date de dernière MàJ du fournisseur'
    ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('gln13'),
    schema='app_schema'
    )
    op.create_table('tags', # pylint: disable=E1101
    sa.Column(
        'id', sa.Integer(), autoincrement=True, nullable=False, comment='Identifiant unique du tag'
    ),
    sa.Column(
        'name', sa.String(), nullable=False, comment='Nom du tag'
    ),
    sa.Column(
        'description', sa.String(), nullable=False, comment='Description du tag'
    ),
    sa.Column(
        'created_at', sa.DateTime(), nullable=False, comment='Date de création du tag'
    ),
    sa.Column(
        'updated_at', sa.DateTime(), nullable=False, comment='Date de dernière MàJ du tag'
    ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name'),
    schema='app_schema'
    )
    op.create_table('vat_rates',    # pylint: disable=E1101
    sa.Column(
        'id', sa.Integer(), autoincrement=True, nullable=False,
        comment='Identifiant unique du taux de TVA'
    ),
    sa.Column(
        'code', sa.Integer(), nullable=False,
        comment='Code TVA (0=super-réduit, 1=réduit, 2=intermédiaire, 3=normal)'
    ),
    sa.Column(
        'rate', sa.Numeric(precision=5, scale=2), nullable=False,
        comment='Taux de TVA en pourcentage (ex: 5.50)'
    ),
    sa.Column(
        'label', sa.String(), nullable=False,
        comment='Libellé du taux (ex: Taux réduit)'
    ),
    sa.Column(
        'date_start', sa.DateTime(timezone=True), nullable=False,
        comment='Date de début de validité du taux'
    ),
    sa.Column(
        'date_end', sa.DateTime(timezone=True), nullable=True,
    ...
    op.create_table('customer_addresses',   # pylint: disable=E1101
    ...
    sa.Column('last_synced_at', sa.DateTime(), nullable=True, comment=DERNIERE_SYNCHRO),
    sa.ForeignKeyConstraint(['customer_id'], ['app_schema.customers.id'], ),
