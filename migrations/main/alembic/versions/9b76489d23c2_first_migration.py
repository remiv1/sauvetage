...
Revision ID: 9b76489d23c2
Revises: 
Create Date: 2026-08-10 06:51:22.389750
...
def upgrade() -> None:
    ...
    op.create_table('object_sync_logs',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('entity_type', sa.String(length=50), nullable=False, comment="Type d'entité : object, tag, picture, vat_rate"),
    sa.Column('entity_id', sa.Integer(), nullable=True, comment="ID local de l'entité dans la base de données"),
    sa.Column('external_id', sa.String(length=100), nullable=True, comment="ID de l'entité dans le système externe (ex : WooCommerce)"),
    sa.Column('external_system', sa.String(length=50), nullable=False, comment='Système externe : wpwc, henrri, …'),
    sa.Column('sync_direction', sa.String(length=20), nullable=False, comment='Direction : inbound, outbound'),
    sa.Column('operation', sa.String(length=20), nullable=False, comment='Opération : create, update, delete, batch'),
    sa.Column('sync_status', sa.String(length=20), nullable=False, comment='Statut : success, error'),
    sa.Column('error_message', sa.String(), nullable=True, comment="Message d'erreur en cas d'échec"),
    ...
    sa.Column('wpwc_id', sa.Integer(), nullable=True, comment='Identifiant du tag dans WooCommerce (si synchronisé)'),
    ...
    sa.Column('is_active', sa.Boolean(), nullable=False, comment='Indique si le tag est actif'),
    ...
    sa.Column('wpwc_id', sa.Integer(), nullable=True, comment='Identifiant du taux de TVA dans WooCommerce (si synchronisé)'),
    sa.Column('wpwc_slug', sa.String(), nullable=True, comment="Slug de la classe de taxe WooCommerce (ex: 'standard', 'taux-reduit')"),
    ...
    sa.Column('henrri_id', sa.Integer(), nullable=True, comment='Identifiant HENRRI associé'),
    ...
    sa.Column('contact_henrri_id', sa.Integer(), nullable=True, comment='Identifiant de contact Henrri'),
    ...
    sa.Column('wpwc_id', sa.Integer(), nullable=True, comment="Identifiant de l'objet dans WooCommerce (si synchronisé)"),
    sa.Column('henrri_id', sa.Integer(), nullable=True, comment="Identifiant de l'objet chez Henrri (si synchronisé)"),
    ...
    sa.Column('author', sa.String(), nullable=True, comment='Auteur du livre'),
    sa.Column('diffuser', sa.String(), nullable=True, comment='Diffuseur du livre'),
    sa.Column('editor', sa.String(), nullable=True, comment='Éditeur du livre'),
    sa.Column('genre', sa.String(), nullable=True, comment='Genre du livre'),
    sa.Column('publication_year', sa.Integer(), nullable=True, comment='Année de publication du livre'),
    sa.Column('pages', sa.Integer(), nullable=True, comment='Nombre de pages du livre'),
    ...
    sa.Column('wpwc_id', sa.Integer(), nullable=True, comment='Identifiant du fichier média dans WooCommerce (si synchronisé)'),
    ...
    sa.Column('file_link', sa.String(), nullable=True, comment='Lien vers le fichier média (URL externe ou nom de fichier local)'),
    sa.Column('is_local', sa.Boolean(), nullable=False, comment='Indique si le fichier est stocké localement sur le volume'),
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('wpwc_id', sa.Integer(), nullable=True, comment='ID de la commande dans WooCommerce'),
    sa.Column('reference', sa.String(length=14), nullable=False),
    sa.Column('customer_id', sa.Integer(), nullable=False),
    sa.Column('invoice_address_id', sa.Integer(), nullable=True, comment='Adresse de facturation'),
    ...
    sa.Column('customer_id', sa.Integer(), nullable=False, comment='Client de la facture'),
    sa.Column('henrri_id', sa.String(length=50), nullable=True, comment='ID externe de la facture (Henrri)'),
    sa.Column('reference', sa.String(length=14), nullable=False),
    ...
    sa.Column('wpwc_id', sa.Integer(), nullable=True, comment='ID de la ligne de commande dans WooCommerce'),
    ...
    sa.Column('object_variation_id', sa.Integer(), nullable=True, comment='Variation de produit sélectionnée pour cette ligne'),
    sa.ForeignKeyConstraint(['general_object_id'], ['app_schema.general_objects.id'], ),
    sa.ForeignKeyConstraint(['object_variation_id'], ['app_schema.object_variations.id'], ),
    sa.ForeignKeyConstraint(['order_id'], ['app_schema.orders.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('wpwc_id'),
    schema='app_schema'
    ...
    sa.Column('henrri_id', sa.Integer(), nullable=True, comment='ID de la ligne de facture chez Henrri'),
